...
namespace OrdersExtentions.Extensions
{
    public static class UsedSession
    {
        ...
        public static void UsedAccess()
        {
            ...
            {
                //string[] str = new[] {""};
                //string OrdersExtentions = WebConfigurationManager.AppSettings["OrdersExtentions"];
                ...
                // str = new[] { @"[HKEY_CURRENT_USER\Software\" + OrdersExtentions + "]" };
                ...
                //var sn = Registry.GetValue(@"HKEY_CURRENT_USER\Software\" + OrdersExtentions, "ACCESS", "null") ?? "null";
                //if (sn == "null")
                //{
                //    //RegistryKey reg;
                //    //reg = Registry.CurrentUser.OpenSubKey("software", true);
                //    //reg.CreateSubKey(OrdersExtentions);
                ...
                //    //sms.SendAdmin(09120448735, Crypto.Decrypt(name), OrdersExtentions, Crypto.Decrypt(hdd), Crypto.Decrypt(ip), Crypto.Decrypt(datestart));
                //}
