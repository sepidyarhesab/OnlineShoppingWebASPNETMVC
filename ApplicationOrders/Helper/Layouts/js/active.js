...
if (document.querySelectorAll(".image-gallery-slides-wrapper-1").length > 0) {
    var partnerslides2 = tns({
        container: ".image-gallery-carousel-1",
        items: 2,
        gutter: 16,
        slideBy: "page",
        autoplay: true,
...
if (document.querySelectorAll(".image-gallery-slides-wrapper-2").length > 0) {
    var partnerslides2 = tns({
        container: ".image-gallery-carousel-2",
        items: 2,
        gutter: 16,
        slideBy: "page",
        autoplay: true,
...
if (document.querySelectorAll(".image-gallery-slides-wrapper-3").length > 0) {
    var partnerslides2 = tns({
        container: ".image-gallery-carousel-3",
        items: 2,
        gutter: 16,
        slideBy: "page",
        autoplay: true,
...
if (document.querySelectorAll(".image-gallery-slides-wrapper-4").length > 0) {
    var partnerslides2 = tns({
        container: ".image-gallery-carousel-4",
        items: 2,
        gutter: 16,
        slideBy: "page",
        autoplay: true,
...
if (document.querySelectorAll(".image-gallery-slides-wrapper-5").length > 0) {
    var partnerslides2 = tns({
        container: ".image-gallery-carousel-5",
        items: 2,
        gutter: 16,
        slideBy: "page",
        autoplay: true,
