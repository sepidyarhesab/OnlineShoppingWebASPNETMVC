...
namespace WebApplicationOrders.Controllers
{
    public class DashboardController : Controller
    {
        ...
        public ActionResult SubmitPicture(HttpPostedFileBase file)
        {
            if (Session["PicturesId"] != null)
            {
                ...
                if (file != null)
                {
                    ...
                    string pathCombine =
                        System.Web.HttpContext.Current.Server.MapPath(ServerPath.ServerPathFileUploadMainFactor +
        ...
        [HttpPost]
        public ActionResult ChangePassword(string olpassword, string newpassword, string trynewpassword)
        {
            var db = new Orders_Entities();
            ...
            TempData["JavaScriptFunction"] =
                        IziToast.Success("عملیات با موفقیت انجام شد", "عملیات با موفقیت انجام شد");
                    return View("Index");
